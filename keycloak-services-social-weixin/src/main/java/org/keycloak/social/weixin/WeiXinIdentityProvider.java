...
//					.queryParam(OAUTH2_PARAMETER_REDIRECT_URI, request.getRedirectUri());//TODO
					.queryParam(OAUTH2_PARAMETER_REDIRECT_URI, WECHAT_REDIRECT_URL);
		} else {
...
//					.param(OAUTH2_PARAMETER_REDIRECT_URI, uriInfo.getAbsolutePath().toString())//TODO
					.param(OAUTH2_PARAMETER_REDIRECT_URI, WECHAT_REDIRECT_URL)
